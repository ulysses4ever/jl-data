...
function eval_model_on_grid_sum(etas::Array, shapes::Array, scales::Array, num_stars = 1600; num_evals = 1,
...
#dist = pmap(tuple->evaluate_model_par(stats_obs, tuple[1], tuple[2], tuple[3], num_stars; minP=minP, maxP=maxP, num_evals=num_evals),idx)
