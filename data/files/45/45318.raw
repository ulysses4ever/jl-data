...
require("functions/redlichKwong.jl") # Set of functions for Redlich-Kwong equation of state
require("functions/equilibrium.jl") # Newton-Raphson iteration for equilibrium calculation
require("functions/saveState.jl")
