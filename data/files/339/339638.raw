...
abstract ThreeValuedLogic <: Integer

immutable TVL <: ThreeValuedLogic
    v::Int8
...
logictables=Dict(zip(["and","or ","xor","imp","ltn","lte","gte","gtn","eql","neq"],
...
function logictable(tablename::String)
    tname = length(tablename) >= 3 ? tablename[1:3] : string(tablename,"  ")[1:3]
...
function unitable(name::String, table::Tuple)
    println()
    println("    ",name,"   |  ")
    println("   ","-------+--------")
    for i in 1:3
