...
if bValidate
    SimulationMatrix = load("validation.jld", "data")

    simulation_number = 25

    labels, initial, AC1_trajectory, AC2_trajectory, AC1_trajectory_ll, AC2_trajectory_ll = SimulationMatrix[simulation_number]
...
elseif bCompareTCAS
    SimulationResult = load("result_tcas.jld", "data")
