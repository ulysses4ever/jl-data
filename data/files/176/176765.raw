function worldnormal(n::Int64; smth=0.01, opening_excluded_frac=0.6, opening_alpha=0.7, dtfrac=0.035)
...
function worldspherical(n::Int64; smth=0.01, opening_excluded_frac=0.6, opening_alpha=0.7, dtfrac=0.035)
    particles = Particle[]
