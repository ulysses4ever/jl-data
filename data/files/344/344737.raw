...
for fn in (CollaborativeFiltering.grad_naive, CollaborativeFiltering.grad_array, CollaborativeFiltering.grad_pred, CollaborativeFiltering.grad_error, CollaborativeFiltering.grad_simd)
