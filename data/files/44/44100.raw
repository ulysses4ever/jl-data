...
min_comp_size_join(a::Int,b::Int,xa::Int,xb::Int) = a+b
min_comp_size_sum(a::Int,b::Int,xa::Int,xb::Int) = min(xa,xb)
min_comp_size(n::Int) = cogen_val(n,0,1,min_comp_size_sum,min_comp_size_join)
...
# minimum degree
min_deg_sum(a::Int,b::Int,xa::Int,xb::Int) = min(xa,xb)
min_deg_join(a::Int,b::Int,xa::Int,xb::Int) = min(xa+b, xb+a)
min_deg(n::Int) = cogen_val(n,0,0,min_deg_sum,min_deg_join)
...
function concat{T}(a::Vector{T}, b::Vector{T})
  result = copy(a)
  append!(result,b)
  return result
end
...
# degree sequence
degseq_sum(a::Int, b::Int, xa::Vector{Int}, xb::Vector{Int}) = concat(xa,xb)
degseq_join(a::Int,b::Int,xa::Vector{Int},xb::Vector{Int})=concat(xa+b,xb+a)
degseq(n::Int) = cogen_val(n,Int[],[0],degseq_sum,degseq_join)
