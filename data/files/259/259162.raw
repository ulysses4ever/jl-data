@enum(Platform,
  ...
  INTEL_NUC5 = 8, PLATFORM_96BOARDS = 9, INTEL_SOFIA_3GR = 10, INTEL_CHERRYHILLS = 11,
...
@enum(GpioMode,
  GPIO_STRONG = 0, GPIO_PULLUP = 1, GPIO_PULLDOWN = 2, GPIO_HIZ = 3
)
...
@enum(GpioEdge,
  GPIO_EDGE_NONE = 0, GPIO_EDGE_BOTH = 1, GPIO_EDGE_RISING = 2,
  GPIO_EDGE_FALLING = 3
)
