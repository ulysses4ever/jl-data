...
function parallelepiped!{I, T, S}(g::GeneralizedMap{I, T, S}, dim)
    ...
    for i in 0:3
        sew!(g.darts[2i+1], g.darts[8i+17], 2) # Sew "bottom" to sides.
        sew!(g.darts[2i+9], g.darts[8i+22], 2) # Sew "top" to sides
        sew!(g.darts[8i+19], g.darts[mod1(8(i+2), 32)+16], 2) # Sew sides together.
    end
end
