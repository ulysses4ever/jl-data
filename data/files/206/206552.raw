...
function test_get_mobil_lane_change()
	...
	cs = CarState[CarState((12.,3,),35.,0,BehaviorModel("aggressive",35.,4.,1)),CarState((11.,1,),27.,0,BehaviorModel("cautious",27.,4.,1)),CarState((6.,1,),31.,0,BehaviorModel("aggressive",35.,4.,1))]
	nbhd = get_adj_cars(pp,cs,3)
	assert(get_mobil_lane_change(pp,cs[3],nbhd),1)
	#CASE: it's slower and there is space
	cs = CarState[CarState((12.,3,),31.,0,BehaviorModel("cautious",31.,4.,1)),CarState((11.,1,),35.,0,BehaviorModel("cautious",35.,4.,1)),CarState((6.,1,),35.,0,BehaviorModel("aggressive",35.,4.,1))]
	nbhd = get_adj_cars(pp,cs,3)
	assert(get_mobil_lane_change(pp,cs[3],nbhd),0)
	#CASE: someone is going fast behind me and i'm slow
	cs = CarState[CarState((0.,1,),35.,0,BehaviorModel("aggressive",35.,4.,1)),CarState((6.,1,),27.,0,BehaviorModel("cautious",27.,4.,1))]
	nbhd = get_adj_cars(pp,cs,2)
	assert(get_mobil_lane_change(pp,cs[2],nbhd),1)
	###repeat for other side
	#CASE: it's faster and there is space
	cs = CarState[CarState((12.,1,),35.,0,BehaviorModel("aggressive",35.,4.,1)),CarState((11.,3,),27.,0,BehaviorModel("cautious",27.,4.,1)),CarState((6.,3,),31.,0,BehaviorModel("aggressive",35.,4.,1))]
	nbhd = get_adj_cars(pp,cs,3)
	assert(get_mobil_lane_change(pp,cs[3],nbhd),-1)
	#CASE: it's slower and there is space
	cs = CarState[CarState((12.,1,),31.,0,BehaviorModel("cautious",31.,4.,1)),CarState((11.,3,),35.,0,BehaviorModel("cautious",35.,4.,1)),CarState((6.,3,),35.,0,BehaviorModel("aggressive",35.,4.,1))]
	nbhd = get_adj_cars(pp,cs,3)
	assert(get_mobil_lane_change(pp,cs[3],nbhd),0)
	#CASE: someone is going fast behind me and i'm slow
	cs = CarState[CarState((0.,3,),35.,0,BehaviorModel("aggressive",35.,4.,1)),CarState((6.,3,),27.,0,BehaviorModel("cautious",27.,4.,1))]
	nbhd = get_adj_cars(pp,cs,2)
	assert(get_mobil_lane_change(pp,cs[2],nbhd),-1)
end
