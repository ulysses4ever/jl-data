...
#     Szz = inv(Z'Z)
#     Szy = Z'Y
#     Sxz*Szz*Sxz'\Sxz*Szz*Szy
# end 

function randiv(n::Int64 = 100; m::Int64 = 5, k::Int64 = 1, theta0::Float64 =
                0.0, rho::Float64 = 0.9, CP::Int64 = 50)
...
function randiv_ts(;n::Int64=128, m::Int64 = 2, σ₁₂::Real = 0.9, ϕ::Real = .5, θ::Real = .5, β::Real = 1.0, burnin::Int64 = 1000)
  ## Same design as in
  ##
