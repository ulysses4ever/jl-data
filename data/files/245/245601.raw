...
#*
#* ------------------------------------------------------------------
type Reboiled_Stripping_thermosyphon
	Reboiled_Stripping_thermosyphon()=begin
		PP=outers.PP
		NComp=outers.NComp
		new(
...
export Reboiled_Stripping_thermosyphon
function set(in::Reboiled_Stripping_thermosyphon)
	top = (NTrays-1)*(1-topdown)/2+1
	 bot = NTrays/top
	 
end
function atributes(in::Reboiled_Stripping_thermosyphon,_::Dict{Symbol,Any})
	fields::Dict{Symbol,Any}=Dict{Symbol,Any}()
	fields[:Pallete]=true
	fields[:Icon]="icon/ReboiledThermosyphon"
	fields[:Brief]="Model of a reboiled stripping column with steady reboiler."
	fields[:Info]="== Specify ==
...
Reboiled_Stripping_thermosyphon(_::Dict{Symbol,Any})=begin
	newModel=Reboiled_Stripping_thermosyphon()
