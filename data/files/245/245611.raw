...
#*
#* ------------------------------------------------------------------
type Refluxed_Absorption_subcooling
	Refluxed_Absorption_subcooling()=begin
		PP=outers.PP
		NComp=outers.NComp
		new(
...
export Refluxed_Absorption_subcooling
function set(in::Refluxed_Absorption_subcooling)
	top = (NTrays-1)*(1-topdown)/2+1
	 bot = NTrays/top
	 
end
function setEquationFlow(in::Refluxed_Absorption_subcooling)
...
function atributes(in::Refluxed_Absorption_subcooling,_::Dict{Symbol,Any})
	fields::Dict{Symbol,Any}=Dict{Symbol,Any}()
	fields[:Pallete]=true
	fields[:Icon]="icon/RefluxedSubcooling"
	fields[:Brief]="Model of a refluxed absorption column with steady condenser."
	fields[:Info]="== Specify ==
...
Refluxed_Absorption_subcooling(_::Dict{Symbol,Any})=begin
	newModel=Refluxed_Absorption_subcooling()
