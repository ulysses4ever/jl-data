...
export Rectifier
function set(in::Rectifier)
	top = (NTrays-1)*(1-topdown)/2+1
	 bot = NTrays/top
	 
end
function setEquationFlow(in::Rectifier)
...
function atributes(in::Rectifier,_::Dict{Symbol,Any})
	fields::Dict{Symbol,Any}=Dict{Symbol,Any}()
	fields[:Pallete]=true
	fields[:Icon]="icon/RefluxedCond"
	fields[:Brief]="Model of a rectifier column with dynamic condenser."
	fields[:Info]="== Specify ==
...
Rectifier(_::Dict{Symbol,Any})=begin
	newModel=Rectifier()
