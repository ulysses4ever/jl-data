...
#*---------------------------------------------------------------------
type Distillation_kettle_cond_EffFund
	Distillation_kettle_cond_EffFund()=begin
		PP=outers.PP
		NComp=outers.NComp
		iLK=outers.iLK
		iHK=outers.iHK
...
export Distillation_kettle_cond_EffFund
function set(in::Distillation_kettle_cond_EffFund)
	top = (NTrays-1)*(1-topdown)/2+1
	 bot = NTrays/top
	 
end
function setEquationFlow(in::Distillation_kettle_cond_EffFund)
...
function atributes(in::Distillation_kettle_cond_EffFund,_::Dict{Symbol,Any})
...
Distillation_kettle_cond_EffFund(_::Dict{Symbol,Any})=begin
	newModel=Distillation_kettle_cond_EffFund()
