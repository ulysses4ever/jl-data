...
@everywhere begin
    ...
    type Events
        ...
        function Events(fnames::Vector{ASCIIString})
            ...
            return new(C_NULL, ev, Dict{InputTag, Ptr{Void}}(), Dict{(Symbol, Symbol), InputTag}(), 0)
        end
    end
    ...
    ev = Events(
        ["/Users/joosep/Documents/stpol/data/Sep19_qcdiso/iso/nominal/QCDMu/output_1_1_AKn.root",
        "/Users/joosep/Documents/stpol/data/Sep19_qcdiso/iso/nominal/QCDMu/output_2_1_hi5.root"]
    )
