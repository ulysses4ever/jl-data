...
@test typeof(convert(BigFloat, 1//2)) == BigFloat{precision(BigFloat)}
@test convert(BigFloat, 0.5) == parse(BigFloat,"0.5")
@test typeof(convert(BigFloat, 0.5)) == BigFloat{precision(BigFloat)}
@test convert(BigFloat, 40) == parse(BigFloat,"40")
@test typeof(convert(BigFloat, 40)) == BigFloat{precision(BigFloat)}
@test convert(BigFloat, Float32(0.5)) == parse(BigFloat,"0.5")
@test typeof(convert(BigFloat, Float32(0.5))) == BigFloat{precision(BigFloat)}
@test convert(BigFloat, parse(BigInt,"9223372036854775808")) == parse(BigFloat,"9223372036854775808")
@test typeof(convert(BigFloat, parse(BigInt,"9223372036854775808"))) == BigFloat{precision(BigFloat)}
@test convert(AbstractFloat, parse(BigInt,"9223372036854775808")) == parse(BigFloat,"9223372036854775808")
@test typeof(convert(AbstractFloat, parse(BigInt,"9223372036854775808"))) == BigFloat{precision(BigFloat)}
...
@test ceil(x) == z
@test typeof(ceil(x)) == BigFloat{precision(BigFloat)}
@test floor(x) == y
@test typeof(floor(x)) == BigFloat{precision(BigFloat)}
@test trunc(x) == y
@test typeof(trunc(x)) == BigFloat{precision(BigFloat)}
...
@test typeof(a * 2) == BigFloat{precision(BigFloat)}
...
@test typeof(BigFloat(typemax(Int8))) == BigFloat{precision(BigFloat)}
@test typeof(BigFloat(typemax(Int16))) == BigFloat{precision(BigFloat)}
@test typeof(BigFloat(typemax(Int32))) == BigFloat{precision(BigFloat)}
@test typeof(BigFloat(typemax(Int64))) == BigFloat{precision(BigFloat)}
@test typeof(BigFloat(typemax(Int128))) == BigFloat{precision(BigFloat)}

@test typeof(BigFloat(true)) == BigFloat{precision(BigFloat)}
@test typeof(BigFloat(typemax(UInt8))) == BigFloat{precision(BigFloat)}
@test typeof(BigFloat(typemax(UInt16))) == BigFloat{precision(BigFloat)}
@test typeof(BigFloat(typemax(UInt32))) == BigFloat{precision(BigFloat)}
@test typeof(BigFloat(typemax(UInt64))) == BigFloat{precision(BigFloat)}
@test typeof(BigFloat(typemax(UInt128))) == BigFloat{precision(BigFloat)}

@test typeof(BigFloat(realmax(Float32))) == BigFloat{precision(BigFloat)}
@test typeof(BigFloat(realmax(Float64))) == BigFloat{precision(BigFloat)}

@test typeof(BigFloat(BigInt(1))) == BigFloat{precision(BigFloat)}
@test typeof(BigFloat(BigFloat(1))) == BigFloat{precision(BigFloat)}

@test typeof(BigFloat(1//1)) == BigFloat{precision(BigFloat)}
@test typeof(BigFloat(one(Rational{BigInt}))) == BigFloat{precision(BigFloat)}
