# This example will illustrate how to model a classic predator/prey 
# dynamic system using system dynamics. This modle simulates the 
# interaction between a predator (foxes) and their prey (rabbits), over 
