...
error = FT_New_Face(library[1], bytestring("data/fonts/Lato-Lig.otf"), int32(0), pointer(face))
assert(error == 0)
FT_Set_Char_Size(face[1], int32(height * 64), int32(height * 64), uint32(96), uint32(96))
