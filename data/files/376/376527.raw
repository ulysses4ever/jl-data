...
getkeystate(keycode::Integer) = ccall((:getKeyState, dllName), Int8, (Int32,), keycode)
get_async_key_state(keycode::Integer) = ccall((:getAsyncKeyState, dllName), Int8, (Int32,), keycode)
