...
function blocks2proc!(b::Block, i)
  ...
  for block in b.children
    if block.isLeaf
      ...
      block.procID = workerID[i]
      for cell in block.cells
        cell.procID = workerID[i]
      end
      i += 1
    else
      blocks2proc!(block, i)
...
function split_block(b::Block)
  ...
  b.children[1] = Block(xc1, b.halfSize/2.0, true, Array(Block, 8), Cell[], b.nestingLevel+1, b.nx, b.ny, b.nz, 0)
  b.children[2] = Block(xc2, b.halfSize/2.0, true, Array(Block, 8), Cell[], b.nestingLevel+1, b.nx, b.ny, b.nz, 0)
  b.children[3] = Block(xc3, b.halfSize/2.0, true, Array(Block, 8), Cell[], b.nestingLevel+1, b.nx, b.ny, b.nz, 0)
  b.children[4] = Block(xc4, b.halfSize/2.0, true, Array(Block, 8), Cell[], b.nestingLevel+1, b.nx, b.ny, b.nz, 0)
  b.children[5] = Block(xc5, b.halfSize/2.0, true, Array(Block, 8), Cell[], b.nestingLevel+1, b.nx, b.ny, b.nz, 0)
  b.children[6] = Block(xc6, b.halfSize/2.0, true, Array(Block, 8), Cell[], b.nestingLevel+1, b.nx, b.ny, b.nz, 0)
  b.children[7] = Block(xc7, b.halfSize/2.0, true, Array(Block, 8), Cell[], b.nestingLevel+1, b.nx, b.ny, b.nz, 0)
  b.children[8] = Block(xc8, b.halfSize/2.0, true, Array(Block, 8), Cell[], b.nestingLevel+1, b.nx, b.ny, b.nz, 0)
  b.isLeaf = false
