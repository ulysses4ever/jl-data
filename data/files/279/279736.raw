    ...
    elseif order == 2
        ...
        for i = 1:npts
            ...
            elseif i == npts-1
                ...
                h[3] =r[i-1]-r[i]
                h[5] =r[i+1]-r[i]
                Lu[i]=-(((-1+d)Du[1]h[2]h[3]h[5])/(h[1]*(h[1]-h[2])*(h[1]-h[3])*(h[1]-h[5])r[4]))+(Du[5]*((-1+d)h[1]h[2]h[3]-2(h[2]+h[3])*(h[1]-h[5])r[4]))/((h[2]-h[5])h[5]*(-h[1]+h[5])*(-h[3]+h[5])r[4])+(Du[3]*((-1+d)h[1]h[2]h[5]-2(h[1]-h[3])*(h[2]+h[5])r[4]))/((h[2]-h[3])h[3]*(-h[1]+h[3])*(h[3]-h[5])r[4])+(Du[2]*(-(-1+d)h[1]h[3]h[5]+2(h[1]-h[2])*(h[3]+h[5])r[4]))/(h[2]*(-h[1]+h[2])*(h[2]-h[3])*(h[2]-h[5])r[4])
            elseif i == npts
                Du[1]=u[i-4]-u[i]
                Du[2]=u[i-3]-u[i]
                Du[3]=u[i-2]-u[i]
                ...
                h[3] =r[i-2]-r[i]
                h[4] =r[i-1]-r[i]
                Lu[i]=-(((-1+d)Du[1]h[2]h[3]h[4])/(h[1]*(h[1]-h[2])*(h[1]-h[3])*(h[1]-h[4])r[5]))+(Du[4]*((-1+d)h[1]h[2]h[3]-2(h[2]+h[3])*(h[1]-h[4])r[5]))/((h[2]-h[4])h[4]*(-h[1]+h[4])*(-h[3]+h[4])r[5])+(Du[3]*((-1+d)h[1]h[2]h[4]-2(h[1]-h[3])*(h[2]+h[4])r[5]))/((h[2]-h[3])h[3]*(-h[1]+h[3])*(h[3]-h[4])r[5])+(Du[2]*(-(-1+d)h[1]h[3]h[4]+2(h[1]-h[2])*(h[3]+h[4])r[5]))/(h[2]*(-h[1]+h[2])*(h[2]-h[3])*(h[2]-h[4])r[5])
            else
                Du[1]=u[i-2]-u[i]
                Du[2]=u[i-1]-u[i]
                Du[4]=u[i+1]-u[i]
