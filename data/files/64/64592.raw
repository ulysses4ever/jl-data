...
function cudnnSoftmaxBackward(handle::cudnnHandle_t,algorithm::Int,mode::Int,alpha,srcDesc::cudnnTensorDescriptor_t,srcData::CuPtr,srcDiffDesc::cudnnTensorDescriptor_t,srcDiffData::CuPtr,beta,destDiffDesc::cudnnTensorDescriptor_t,destDiffData::CuPtr)
