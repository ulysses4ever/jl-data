...
SR1State(d :: Int64) = SR1State(Array(Vector{Float64},0),Array(Vector{Float64},0),1.0,
 zeros(d,0),zeros(0))
...
function update(delta_x, delta_g, m, state :: SR1State)
  ...
  if  LHS > 1E-8*RHS #this always happens.
    ...
    return SR1State(old_dirs, old_stps, Hdiag, L,D)
  else
