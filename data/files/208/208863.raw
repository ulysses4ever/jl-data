...
df_dyn = readtable(joinpath(dirname(@__FILE__),  "input/Proj_Dyn.csv"))
...
for col in [:name, :cost_price_name, :cost_be_name, :qx_name, :interest_name]
...
dyn_dfs = Array(DataFrame,0)
push!(dyn_dfs, df_general)
push!(dyn_dfs, df_dyn)
