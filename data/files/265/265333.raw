...
fileDir = "/home/mkolar/tmp/qr_sim1_tau_0.6"
...
plotParams[1] = [
  "$(fileDir)/noise_1_cor_1_var_1_tau_0.6.jld",
...
plotParams[2] = [
  "$(fileDir)/oracle_noise_1_cor_1_var_1_tau_0.6.jld",
...
plotParams[3] = [
   "$(fileDir)/noise_1_cor_1_var_10_tau_0.6.jld",
...
plotParams[4] = [
 "$(fileDir)/oracle_noise_1_cor_1_var_10_tau_0.6.jld",
...
plotParams[5] = [
  "$(fileDir)/noise_1_cor_1_var_20_tau_0.6.jld",
...
plotParams[6] = [
  "$(fileDir)/oracle_noise_1_cor_1_var_20_tau_0.6.jld",
...
plotParams[7] = [
  "$(fileDir)/noise_1_cor_3_var_1_tau_0.6.jld",
...
plotParams[8] = [
  "$(fileDir)/oracle_noise_1_cor_3_var_1_tau_0.6.jld",
...
plotParams[9] = [
   "$(fileDir)/noise_1_cor_3_var_10_tau_0.6.jld",
...
plotParams[10] = [
 "$(fileDir)/oracle_noise_1_cor_3_var_10_tau_0.6.jld",
...
plotParams[11] = [
  "$(fileDir)/noise_1_cor_3_var_20_tau_0.6.jld",
...
plotParams[12] = [
  "$(fileDir)/oracle_noise_1_cor_3_var_20_tau_0.6.jld",
...
plotParams[13] = [
  "$(fileDir)/noise_2_cor_1_var_1_tau_0.6.jld",
...
plotParams[14] = [
  "$(fileDir)/oracle_noise_2_cor_1_var_1_tau_0.6.jld",
...
plotParams[15] = [
   "$(fileDir)/noise_2_cor_1_var_10_tau_0.6.jld",
...
plotParams[16] = [
 "$(fileDir)/oracle_noise_2_cor_1_var_10_tau_0.6.jld",
...
plotParams[17] = [
  "$(fileDir)/noise_2_cor_1_var_20_tau_0.6.jld",
...
plotParams[18] = [
  "$(fileDir)/oracle_noise_2_cor_1_var_20_tau_0.6.jld",
...
plotParams[19] = [
  "$(fileDir)/noise_2_cor_3_var_1_tau_0.6.jld",
...
plotParams[20] = [
  "$(fileDir)/oracle_noise_2_cor_3_var_1_tau_0.6.jld",
...
plotParams[21] = [
   "$(fileDir)/noise_2_cor_3_var_10_tau_0.6.jld",
...
plotParams[22] = [
 "$(fileDir)/oracle_noise_2_cor_3_var_10_tau_0.6.jld",
...
plotParams[23] = [
  "$(fileDir)/noise_2_cor_3_var_20_tau_0.6.jld",
...
plotParams[24] = [
  "$(fileDir)/oracle_noise_2_cor_3_var_20_tau_0.6.jld",
