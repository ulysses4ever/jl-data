...
export Section_Column2
function set(in::Section_Column2)
	_base_1.NumberOfFeeds = 2
	 
end
function setEquationFlow(in::Section_Column2)
...
function atributes(in::Section_Column2,_::Dict{Symbol,Any})
...
Section_Column2(_::Dict{Symbol,Any})=begin
	newModel=Section_Column2()
