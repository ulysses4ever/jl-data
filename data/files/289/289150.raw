...
function get_conditional_counts!(PP::ConditionalCounts, x::Array{Int64,1}, groups::AbstractArray{Int64,2})
...
function get_conditional_counts(x::Array{Int64,1}, groups::AbstractArray{Int64,2})
	mx = maximum(x)+1
