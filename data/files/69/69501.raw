...
#In Wilkinson's second experiment, Hag is observed.
  obs_mol_name = "SigD"
...
using Dates
  MCS.save_path = string("/Users/EricKernfeld/Desktop/Spring_2015/518/eric_prelim_code/julia_version/project_specific/replication_exps/bw_replic_attempts/", now(), "/")
  mkdir(MCS.save_path)
