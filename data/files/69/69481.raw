println("warning: run_test_generic has been deprecated in favor of start_off_test.")
...
#-----------------------------do the inference-------------------------------
tic()
  pMCMC_julia.pMCMC!(sim_results.d_obs, sim_results.t_obs, MCS, length(sim_results.t_obs))
  ep.time_taken = toc()
