...
function startsimulation(tinicial, tmax, N, Lx1, Lx2, Ly1, Ly2, etotal, masses, radii)
  particulas = createdisks(N,Lx1,Lx2,Ly1,Ly2,etotal,masses,radii)
...
function simulation(tinicial, tmax, N, Lx1, Lx2, Ly1, Ly2, etotal, masses, radii)
  particulas, paredes, posiciones, velocidades, masas, pq, t, tiempo = startsimulation(tinicial, tmax, N, Lx1, Lx2, Ly1, Ly2, etotal, masses, radii)
  label = 0
  while(!isempty(pq))
    label += 1
    evento = Collections.dequeue!(pq)
...
#     particulas, paredes, posiciones, velocidades, masas, pq, t, tiempo = startsimulation(tinicial, tmax, N, Lx1, Lx2, Ly1, Ly2, vmin, vmax)
#     label = 0
