...
function visualize(simulation_results, N, Lx1, Lx2, Ly1, Ly2, r, h, t_max)
  ...
  drawwalls(ax, Lx1,Lx2,Ly1, Ly2, r,h)
  ax[:set_xlim](Lx1, 2*Lx2)
  ax[:set_ylim](Ly1, 2*Ly2)
...
function drawwalls(ax, Lx1,Lx2,Ly1, Ly2, r,h)

  ##Notation for lines: from x1,y1, to x2, y2, Line2D([x1,x2],[y1,y2])
  line1 = lines.Line2D([Lx1,Lx2],[Ly1,Ly1])
  line2 = lines.Line2D([Lx1,Lx1],[Ly1,Ly2])
  line3 = lines.Line2D([Lx2,Lx2],[Ly1,Ly2 - (r+h/2.)])
  line4 = lines.Line2D([Lx1,Lx2 - (r+h/2.)],[Ly2 , Ly2])
  ax[:add_line](line1)
  ax[:add_line](line2)
  ax[:add_line](line3)
  ax[:add_line](line4)
