...
acasx_gp_tree(;seed=$i, outdir=Pkg.dir("GrammarExpts/results/ACASX_GP_Tree/seed$i"), config...)
...
acasx_ge_tree(;seed=$i, outdir=Pkg.dir("GrammarExpts/results/ACASX_GE_Tree/seed$i"), config...)
...
acasx_mc_tree(;seed=$i, outdir=Pkg.dir("GrammarExpts/results/ACASX_MC_Tree/seed$i"), config...)
...
acasx_mcts_tree(;seed=$i, outdir=Pkg.dir("GrammarExpts/results/ACASX_MCTS_Tree/seed$i"), config...)
