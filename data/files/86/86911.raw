...
function fit_nn_model(h5_file, train_sessions, labels)
    ...
    @time model = fit(fea, tar, classification_net_options(hidden_layers=[50], stop_criteria=StopAfterIteration(50)))
...
inter_subject_train_valid(hdf5_data_file, labels_file, fit_augmented_nn_model, extract_features)
