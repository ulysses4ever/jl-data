# took from https://github.com/JuliaLang/IniFile.jl/blob/master/src/IniFile.jl
# thx
...
typealias HTSS Dict{ASCIIString,ASCIIString}

type IniFile
    sections::Dict{ASCIIString,HTSS}
    defaults::HTSS
end

IniFile() = IniFile((ASCIIString=>HTSS)[], HTSS())
