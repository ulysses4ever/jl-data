...
function 删除引擎(engine::Union(结巴分词,Nothing))
    ...
    ccall(free_mix_key,Void,(Ptr{Void},),engine.固定元素.引擎)
    elseif engine.固定元素.引擎类型== "概率"
    ccall(free_mp_key,Void,(Ptr{Void},),engine.固定元素.引擎)
    elseif engine.固定元素.引擎类型== "hmm"
    ccall(free_hmm_key,Void,(Ptr{Void},),engine.固定元素.引擎)
    elseif engine.固定元素.引擎类型== "索引"
    ccall(free_qu_key,Void,(Ptr{Void},),engine.固定元素.引擎)  
    elseif engine.固定元素.引擎类型== "标记"
    ccall(free_tag_key,Void,(Ptr{Void},),engine.固定元素.引擎)  
    elseif engine.固定元素.引擎类型== "关键词"
    ccall(free_key_key,Void,(Ptr{Void},),engine.固定元素.引擎)  
    elseif engine.固定元素.引擎类型== "simhash"
    ccall(free_sim_key,Void,(Ptr{Void},),engine.固定元素.引擎)  
    end
    engine.引擎状态  = true
