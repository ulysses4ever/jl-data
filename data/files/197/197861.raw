...
function delete_worker(engine::Union(SegmentWorker,Nothing))
    ...
    ccall(free_mix_key,Void,(Ptr{Void},),engine.private.worker)
    elseif engine.private.worker_type == "mp"
    ccall(free_mp_key,Void,(Ptr{Void},),engine.private.worker)
    elseif engine.private.worker_type == "hmm"
    ccall(free_hmm_key,Void,(Ptr{Void},),engine.private.worker)
    elseif engine.private.worker_type == "query"
    ccall(free_qu_key,Void,(Ptr{Void},),engine.private.worker)  
    elseif engine.private.worker_type == "tag"
    ccall(free_tag_key,Void,(Ptr{Void},),engine.private.worker)  
    elseif engine.private.worker_type == "keywords"
    ccall(free_key_key,Void,(Ptr{Void},),engine.private.worker)  
