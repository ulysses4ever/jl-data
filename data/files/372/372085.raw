# Julia wrapper for header: /opt/local/include/gdal_proxy.h
...
function GDALProxyPoolDatasetCreate(pszSourceDatasetDescription::Ptr{Uint8},nRasterXSize::Cint,nRasterYSize::Cint,eAccess::GDALAccess,bShared::Cint,pszProjectionRef::Ptr{Uint8},padfGeoTransform::Ptr{Cdouble})
    ccall((:GDALProxyPoolDatasetCreate,libgdal),GDALProxyPoolDatasetH,(Ptr{Uint8},Cint,Cint,GDALAccess,Cint,Ptr{Uint8},Ptr{Cdouble}),pszSourceDatasetDescription,nRasterXSize,nRasterYSize,eAccess,bShared,pszProjectionRef,padfGeoTransform)
end

function GDALProxyPoolDatasetDelete(hProxyPoolDataset::GDALProxyPoolDatasetH)
    ccall((:GDALProxyPoolDatasetDelete,libgdal),Void,(GDALProxyPoolDatasetH,),hProxyPoolDataset)
end

function GDALProxyPoolDatasetAddSrcBandDescription(hProxyPoolDataset::GDALProxyPoolDatasetH,eDataType::GDALDataType,nBlockXSize::Cint,nBlockYSize::Cint)
    ccall((:GDALProxyPoolDatasetAddSrcBandDescription,libgdal),Void,(GDALProxyPoolDatasetH,GDALDataType,Cint,Cint),hProxyPoolDataset,eDataType,nBlockXSize,nBlockYSize)
end
