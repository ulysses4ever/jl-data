...
function GDALdllImagePoint(nRasterXSize::Cint,nRasterYSize::Cint,nPartCount::Cint,panPartSize::Ptr{Cint},padfX::Ptr{Cdouble},padfY::Ptr{Cdouble},padfVariant::Ptr{Cdouble},pfnPointFunc::llPointFunc,pCBData::Ptr{Void})
    ccall((:GDALdllImagePoint,libgdal),Void,(Cint,Cint,Cint,Ptr{Cint},Ptr{Cdouble},Ptr{Cdouble},Ptr{Cdouble},llPointFunc,Ptr{Void}),nRasterXSize,nRasterYSize,nPartCount,panPartSize,padfX,padfY,padfVariant,pfnPointFunc,pCBData)
end

function GDALdllImageLine(nRasterXSize::Cint,nRasterYSize::Cint,nPartCount::Cint,panPartSize::Ptr{Cint},padfX::Ptr{Cdouble},padfY::Ptr{Cdouble},padfVariant::Ptr{Cdouble},pfnPointFunc::llPointFunc,pCBData::Ptr{Void})
    ccall((:GDALdllImageLine,libgdal),Void,(Cint,Cint,Cint,Ptr{Cint},Ptr{Cdouble},Ptr{Cdouble},Ptr{Cdouble},llPointFunc,Ptr{Void}),nRasterXSize,nRasterYSize,nPartCount,panPartSize,padfX,padfY,padfVariant,pfnPointFunc,pCBData)
end

function GDALdllImageLineAllTouched(nRasterXSize::Cint,nRasterYSize::Cint,nPartCount::Cint,panPartSize::Ptr{Cint},padfX::Ptr{Cdouble},padfY::Ptr{Cdouble},padfVariant::Ptr{Cdouble},pfnPointFunc::llPointFunc,pCBData::Ptr{Void})
    ccall((:GDALdllImageLineAllTouched,libgdal),Void,(Cint,Cint,Cint,Ptr{Cint},Ptr{Cdouble},Ptr{Cdouble},Ptr{Cdouble},llPointFunc,Ptr{Void}),nRasterXSize,nRasterYSize,nPartCount,panPartSize,padfX,padfY,padfVariant,pfnPointFunc,pCBData)
end

function GDALdllImageFilledPolygon(nRasterXSize::Cint,nRasterYSize::Cint,nPartCount::Cint,panPartSize::Ptr{Cint},padfX::Ptr{Cdouble},padfY::Ptr{Cdouble},padfVariant::Ptr{Cdouble},pfnScanlineFunc::llScanlineFunc,pCBData::Ptr{Void})
    ccall((:GDALdllImageFilledPolygon,libgdal),Void,(Cint,Cint,Cint,Ptr{Cint},Ptr{Cdouble},Ptr{Cdouble},Ptr{Cdouble},llScanlineFunc,Ptr{Void}),nRasterXSize,nRasterYSize,nPartCount,panPartSize,padfX,padfY,padfVariant,pfnScanlineFunc,pCBData)
end

function GDALRegisterTransformDeserializer(pszTransformName::Ptr{Uint8},pfnTransformerFunc::GDALTransformerFunc,pfnDeserializeFunc::GDALTransformDeserializeFunc)
    ccall((:GDALRegisterTransformDeserializer,libgdal),Ptr{Void},(Ptr{Uint8},GDALTransformerFunc,GDALTransformDeserializeFunc),pszTransformName,pfnTransformerFunc,pfnDeserializeFunc)
end

function GDALUnregisterTransformDeserializer(pData::Ptr{Void})
    ccall((:GDALUnregisterTransformDeserializer,libgdal),Void,(Ptr{Void},),pData)
end

function GDALCleanupTransformDeserializerMutex()
    ccall((:GDALCleanupTransformDeserializerMutex,libgdal),Void,())
end

function GDALCloneTPSTransformer(pTransformArg::Ptr{Void})
    ccall((:GDALCloneTPSTransformer,libgdal),Ptr{Void},(Ptr{Void},),pTransformArg)
end

function GDALCloneGenImgProjTransformer(pTransformArg::Ptr{Void})
    ccall((:GDALCloneGenImgProjTransformer,libgdal),Ptr{Void},(Ptr{Void},),pTransformArg)
end

function GDALCloneApproxTransformer(pTransformArg::Ptr{Void})
    ccall((:GDALCloneApproxTransformer,libgdal),Ptr{Void},(Ptr{Void},),pTransformArg)
end

function GDALCreateTPSTransformerInt(nGCPCount::Cint,pasGCPList::Ptr{GDAL_GCP},bReversed::Cint,papszOptions::Ptr{Ptr{Uint8}})
    ccall((:GDALCreateTPSTransformerInt,libgdal),Ptr{Void},(Cint,Ptr{GDAL_GCP},Cint,Ptr{Ptr{Uint8}}),nGCPCount,pasGCPList,bReversed,papszOptions)
end

function GDALCloneTransformer(pTranformerArg::Ptr{Void})
    ccall((:GDALCloneTransformer,libgdal),Ptr{Void},(Ptr{Void},),pTranformerArg)
end

function GDALFloatEquals(A::Cfloat,B::Cfloat)
    ccall((:GDALFloatEquals,libgdal),GBool,(Cfloat,Cfloat),A,B)
end
