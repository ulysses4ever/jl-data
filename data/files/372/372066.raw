# Julia wrapper for header: /opt/local/include/gdaljp2abstractdataset.h
...
function PamParseHistogram(psHistItem::Ptr{CPLXMLNode},pdfMin::Ptr{Cdouble},pdfMax::Ptr{Cdouble},pnBuckets::Ptr{Cint},ppanHistogram::Ptr{Ptr{Cint}},pbIncludeOutOfRange::Ptr{Cint},pbApproxOK::Ptr{Cint})
    ccall((:PamParseHistogram,libgdal),Cint,(Ptr{CPLXMLNode},Ptr{Cdouble},Ptr{Cdouble},Ptr{Cint},Ptr{Ptr{Cint}},Ptr{Cint},Ptr{Cint}),psHistItem,pdfMin,pdfMax,pnBuckets,ppanHistogram,pbIncludeOutOfRange,pbApproxOK)
end

function PamFindMatchingHistogram(psSavedHistograms::Ptr{CPLXMLNode},dfMin::Cdouble,dfMax::Cdouble,nBuckets::Cint,bIncludeOutOfRange::Cint,bApproxOK::Cint)
    ccall((:PamFindMatchingHistogram,libgdal),Ptr{CPLXMLNode},(Ptr{CPLXMLNode},Cdouble,Cdouble,Cint,Cint,Cint),psSavedHistograms,dfMin,dfMax,nBuckets,bIncludeOutOfRange,bApproxOK)
end

function PamHistogramToXMLTree(dfMin::Cdouble,dfMax::Cdouble,nBuckets::Cint,panHistogram::Ptr{Cint},bIncludeOutOfRange::Cint,bApprox::Cint)
    ccall((:PamHistogramToXMLTree,libgdal),Ptr{CPLXMLNode},(Cdouble,Cdouble,Cint,Ptr{Cint},Cint,Cint),dfMin,dfMax,nBuckets,panHistogram,bIncludeOutOfRange,bApprox)
end

function PamGetProxy(arg1::Ptr{Uint8})
    ccall((:PamGetProxy,libgdal),Ptr{Uint8},(Ptr{Uint8},),arg1)
end

function PamAllocateProxy(arg1::Ptr{Uint8})
    ccall((:PamAllocateProxy,libgdal),Ptr{Uint8},(Ptr{Uint8},),arg1)
end

function PamDeallocateProxy(arg1::Ptr{Uint8})
    ccall((:PamDeallocateProxy,libgdal),Ptr{Uint8},(Ptr{Uint8},),arg1)
end

function PamCleanProxyDB()
    ccall((:PamCleanProxyDB,libgdal),Void,())
end
