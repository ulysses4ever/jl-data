...
function GDALWarpNoDataMasker(pMaskFuncArg::Ptr{Void},nBandCount::Cint,eType::GDALDataType,nXOff::Cint,nYOff::Cint,nXSize::Cint,nYSize::Cint,papabyImageData::Ptr{Ptr{GByte}},bMaskIsFloat::Cint,pValidityMask::Ptr{Void})
    ccall((:GDALWarpNoDataMasker,libgdal),CPLErr,(Ptr{Void},Cint,GDALDataType,Cint,Cint,Cint,Cint,Ptr{Ptr{GByte}},Cint,Ptr{Void}),pMaskFuncArg,nBandCount,eType,nXOff,nYOff,nXSize,nYSize,papabyImageData,bMaskIsFloat,pValidityMask)
end
...
function GDALWarpSrcAlphaMasker(pMaskFuncArg::Ptr{Void},nBandCount::Cint,eType::GDALDataType,nXOff::Cint,nYOff::Cint,nXSize::Cint,nYSize::Cint,arg1::Ptr{Ptr{GByte}},bMaskIsFloat::Cint,pValidityMask::Ptr{Void})
    ccall((:GDALWarpSrcAlphaMasker,libgdal),CPLErr,(Ptr{Void},Cint,GDALDataType,Cint,Cint,Cint,Cint,Ptr{Ptr{GByte}},Cint,Ptr{Void}),pMaskFuncArg,nBandCount,eType,nXOff,nYOff,nXSize,nYSize,arg1,bMaskIsFloat,pValidityMask)
end
