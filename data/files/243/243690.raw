...
#*------------------------------------------------------------------
type ShellandTubes_LMTD_cost
	ShellandTubes_LMTD_cost()=begin
		new(
			ShellandTubes_LMTD(),
...
export ShellandTubes_LMTD_cost
function setEquationFlow(in::ShellandTubes_LMTD_cost)
	addEquation(1)
	addEquation(2)
	addEquation(3)
	addEquation(4)
...
function atributes(in::ShellandTubes_LMTD_cost,_::Dict{Symbol,Any})
...
ShellandTubes_LMTD_cost(_::Dict{Symbol,Any})=begin
	newModel=ShellandTubes_LMTD_cost()
	newModel.attributes=atributes(newModel,_)
	newModel
end
addnamestoinventory(ShellandTubes_LMTD_cost)
