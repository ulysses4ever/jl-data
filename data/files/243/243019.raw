...
@everywhere function load_values(x, ini, last)
	println("process_id = $(myid()), ini_position =  $(ini), last_position = $(last)")
	# start_pos = $(id*length(x)/nprocs()), nprocs=$(nprocs())")
end
...
function isn_fft(x)
	...
	println(last)
	println(xtotal)
	pmap((arg1, arg2, arg3) -> load_values(arg1, arg2, arg3), xtotal, ini, last)
