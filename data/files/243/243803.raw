...
#*
#* ------------------------------------------------------------------
type Distillation_kettle_subcooling_cost
	Distillation_kettle_subcooling_cost()=begin
		new(
			Distillation_kettle_subcooling(),
	...
	_P1::Distillation_kettle_subcooling
...
export Distillation_kettle_subcooling_cost
function setEquationFlow(in::Distillation_kettle_subcooling_cost)
	addEquation(1)
	addEquation(2)
	addEquation(3)
	addEquation(4)
...
function atributes(in::Distillation_kettle_subcooling_cost,_::Dict{Symbol,Any})
...
Distillation_kettle_subcooling_cost(_::Dict{Symbol,Any})=begin
	newModel=Distillation_kettle_subcooling_cost()
	newModel.attributes=atributes(newModel,_)
	newModel
end
addnamestoinventory(Distillation_kettle_subcooling_cost)
