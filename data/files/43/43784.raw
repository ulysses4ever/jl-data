...
const SHFAC = [ 346.27919089,    316.31494744,    428.77415608,    336.64508304,    236.30473270,    336.74619578,    288.70277851,      0.0]
const LHFAC = [3103.72241154,   3368.31026468,   1891.16116883,   3046.35853964,   2153.94680805,   2519.93924922,   2787.15394381,      0.0]
const WSPAC = [   6.21164760,      7.18682919,      7.23156993,      7.46575514,      8.88686058,      6.83639998,      6.55919942,      0.0]
const AIRAC = [  19.30935915,     19.30673917,     19.95408684,      0.00000000,     18.55438331,     19.64124990,     19.35620347,      0.0]
const SSTAC = [  20.45962118,     20.23188641,     20.38476145,      0.00000000,     20.47267436,     20.39713228,     29.66222972,      0.0]
const SHUAC = [   9.10224303,      9.02518428,      8.77924409,      9.62170852,      8.56340810,      9.05679297,      9.09048330,      0.0]
const SHFAV = [ 354.91304710,    331.19891935,    434.92706721,    350.52973292,    242.36182333,    346.32495274,    303.01755116,      0.0]
const LHFAV = [3207.92045001,   3470.97483130,   1886.43099649,   3206.45940408,   2220.01346222,   2611.93842196,   2940.93386985,      0.0]
const WSPAV = [   6.48326765,      7.46829421,      7.46881947,      7.73270315,      9.29325042,      7.11064283,      6.86794025,      0.0]
const AIRAV = [  18.94796499,     18.90174979,     19.61569800,      0.00000000,     18.13136937,     19.23381427,     18.88374999,      0.0]
const SSTAV = [  19.93423838,     19.73101768,     19.84960148,      0.00000000,     19.95023923,     19.87054833,     27.06254198,      0.0]
const SHUAV = [   8.84251258,      8.80114875,      8.43621610,      9.25158216,      8.34412240,      8.74748265,      8.75826454,      0.0]

const SHFBC = [ 346.27919089,    316.31494744,    428.77415608,    336.64508304,    236.30473270,    336.74619578,    288.70277851,      0.0]
const LHFBC = [3103.72241154,   3368.31026468,   1891.16116883,   3046.35853964,   2153.94680805,   2519.93924922,   2787.15394381,      0.0]
const WSPBC = [   6.21164760,      7.18682919,      7.23156993,      7.46575514,      8.88686058,      6.83639998,      6.55919942,      0.0]
const AIRBC = [  19.30935915,     19.30673917,     19.95408684,      0.00000000,     18.55438331,     19.64124990,     19.35620347,      0.0]
const SSTBC = [  20.45962118,     20.23188641,     20.38476145,      0.00000000,     20.47267436,     20.39713228,     29.66222972,      0.0]
const SHUBC = [   9.10224303,      9.02518428,      8.77924409,      9.62170852,      8.56340810,      9.05679297,      9.09048330,      0.0]
const SHFBV = [ 354.91304710,    331.19891935,    434.92706721,    350.52973292,    242.36182333,    346.32495274,    303.01755116,      0.0]
const LHFBV = [3207.92045001,   3470.97483130,   1886.43099649,   3206.45940408,   2220.01346222,   2611.93842196,   2940.93386985,      0.0]
const WSPBV = [   6.48326765,      7.46829421,      7.46881947,      7.73270315,      9.29325042,      7.11064283,      6.86794025,      0.0]
const AIRBV = [  18.94796499,     18.90174979,     19.61569800,      0.00000000,     18.13136937,     19.23381427,     18.88374999,      0.0]
const SSTBV = [  19.93423838,     19.73101768,     19.84960148,      0.00000000,     19.95023923,     19.87054833,     27.06254198,      0.0]
const SHUBV = [   8.84251258,      8.80114875,      8.43621610,      9.25158216,      8.34412240,      8.74748265,      8.75826454,      0.0]

const SHFRC = [ 346.27919089,    316.31494744,    428.77415608,    336.64508304,    236.30473270,    336.74619578,    288.70277851,      0.0]
const LHFRC = [3103.72241154,   3368.31026468,   1891.16116883,   3046.35853964,   2153.94680805,   2519.93924922,   2787.15394381,      0.0]
const WSPRC = [   6.21164760,      7.18682919,      7.23156993,      7.46575514,      8.88686058,      6.83639998,      6.55919942,      0.0]
const AIRRC = [  19.30935915,     19.30673917,     19.95408684,      0.00000000,     18.55438331,     19.64124990,     19.35620347,      0.0]
const SSTRC = [  20.45962118,     20.23188641,     20.38476145,      0.00000000,     20.47267436,     20.39713228,     29.66222972,      0.0]
const SHURC = [   9.10224303,      9.02518428,      8.77924409,      9.62170852,      8.56340810,      9.05679297,      9.09048330,      0.0]
const SHFRV = [ 354.91304710,    331.19891935,    434.92706721,    350.52973292,    242.36182333,    346.32495274,    303.01755116,      0.0]
const LHFRV = [3207.92045001,   3470.97483130,   1886.43099649,   3206.45940408,   2220.01346222,   2611.93842196,   2940.93386985,      0.0]
const WSPRV = [   6.48326765,      7.46829421,      7.46881947,      7.73270315,      9.29325042,      7.11064283,      6.86794025,      0.0]
const AIRRV = [  18.94796499,     18.90174979,     19.61569800,      0.00000000,     18.13136937,     19.23381427,     18.88374999,      0.0]
const SSTRV = [  19.93423838,     19.73101768,     19.84960148,      0.00000000,     19.95023923,     19.87054833,     27.06254198,      0.0]
const SHURV = [   8.84251258,      8.80114875,      8.43621610,      9.25158216,      8.34412240,      8.74748265,      8.75826454,      0.0]
    ...
    for (c, ranc) in enumerate(RANGC)
      ...
      for (d, line) in enumerate(lines)                                       # (possibly after recalibrating)
        if dist[d] <= lims && e <= chnk
          vals = float(split(line))
          flux[1,e,:] = [vals[ERAB] vals[HOAB] vals[IFRB] vals[JOFB] vals[MERB] vals[OAFB] vals[SEAB] vals[OFLX] vals[AIRT]]
          flux[2,e,:] = [vals[ERAA] vals[HOAA] vals[IFRA] vals[JOFA] vals[MERA] vals[OAFA] vals[SEAA] vals[WSPD] vals[SSTT]]
if RECALIB && !RECALIB
            for f = 1:ANALYS
      ...
      if RECALIB
        ...
        form = @sprintf("const %sA%c = [%15.8lf, %15.8lf, %15.8lf, %15.8lf, %15.8lf, %15.8lf, %15.8lf, %15.8lf,      0.0]\n",
          varname[1:3], varname[5], MISS, allalp[1], allalp[2], allalp[3], allalp[4], allalp[5], allalp[6], allalp[7])
        write(fpb, form)
        form = @sprintf("const %sB%c = [%15.8lf, %15.8lf, %15.8lf, %15.8lf, %15.8lf, %15.8lf, %15.8lf, %15.8lf,      1.0]\n",
          varname[1:3], varname[5], MISS, allbet[1], allbet[2], allbet[3], allbet[4], allbet[5], allbet[6], allbet[7])
        write(fpb, form)
      ...
      @printf("cala = [%15.8lf, %15.8lf, %15.8lf, %15.8lf, %15.8lf, %15.8lf, %15.8lf, %15.8lf]\n",
        MISS, allalp[1], allalp[2], allalp[3], allalp[4], allalp[5], allalp[6], allalp[7])
      @printf("calb = [%15.8lf, %15.8lf, %15.8lf, %15.8lf, %15.8lf, %15.8lf, %15.8lf, %15.8lf]\n",
        MISS, allbet[1], allbet[2], allbet[3], allbet[4], allbet[5], allbet[6], allbet[7])
      @printf("\ntarget params   AIRT,WSPD,SSTT are %6.2f %6.2f %6.2f\n",   rana, ranb, ranc)
