...
if (contains(ARGS[1], "lhfx") && ARGS[2] ==   "cfsr") ||                      # skip any missing arg combinations
   (contains(ARGS[1], "sstt") && ARGS[2] == "jofuro") ||
   (contains(ARGS[1], "airt") && ARGS[2] == "jofuro")
...
fname = ARGS[1] * "." * ARGS[2] * ".extra.reh"                                # and the corresponding calibrated pairs
fpa = My.ouvre(fname, "r")
line = readline(fpa)
(incb, slcb, inca, slca, oncb, olcb, onca, olca) = float(split(line))
close(fpa)

contains(ARGS[1], "shfx") && (varname = "Sensible Heat Flux (Wm^{-2})")       # define the plot title and limits
contains(ARGS[1], "lhfx") && (varname = "Latent Heat Flux (Wm^{-2})")
contains(ARGS[1], "wspd") && (varname = "Wind Speed (ms^{-1})")
contains(ARGS[1], "airt") && (varname = "Air Temperature (^{o}C)")
contains(ARGS[1], "sstt") && (varname = "Sea Surface Temp (^{o}C)")
contains(ARGS[1], "shum") && (varname = "Specific Humidity (g/kg)")
ARGS[2] ==        "cfsr" && (analysis =        "CFSR")
ARGS[2] ==  "erainterim" && (analysis = "ERA Interim")
ARGS[2] ==       "hoaps" && (analysis =       "HOAPS")
ARGS[2] == "ifremerflux" && (analysis = "IfremerFlux")
ARGS[2] ==      "jofuro" && (analysis =     "J-OFURO")
...
contains(ARGS[1], "shfx") && (xmin = -300 ; xmax =  900 ; ymin =  -300 ; ymax =  900)
contains(ARGS[1], "lhfx") && (xmin = -100 ; xmax = 1200 ; ymin =  -100 ; ymax = 1200)
contains(ARGS[1], "wspd") && (xmin =   -5 ; xmax =   45 ; ymin =    -5 ; ymax =   45)
contains(ARGS[1], "airt") && (xmin =  -20 ; xmax =   40 ; ymin =   -20 ; ymax =   40)
contains(ARGS[1], "sstt") && (xmin =  -10 ; xmax =   40 ; ymin =   -10 ; ymax =   40)
contains(ARGS[1], "shum") && (xmin =    0 ; xmax =   30 ; ymin =     0 ; ymax =   30)
#=
