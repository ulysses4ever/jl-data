...
restore(shfs, shfn, ARGS[1] * "_" * ARGS[2] * ".shfx.dat")
restore(lhfs, lhfn, ARGS[1] * "_" * ARGS[2] * ".lhfx.dat")
restore(wsps, wspn, ARGS[1] * "_" * ARGS[2] * ".wspd.dat")
restore(airs, airn, ARGS[1] * "_" * ARGS[2] * ".airt.dat")
restore(ssts, sstn, ARGS[1] * "_" * ARGS[2] * ".sstt.dat")
restore(shus, shun, ARGS[1] * "_" * ARGS[2] * ".shum.dat")
