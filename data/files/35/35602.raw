...
interp{T<:GridType,BT<:BasisFunction}(xi::Array{Float64},G::NGrid{T,BT},A::Vector{Float64}) = length(G)<1500 ? c_interp(xi,G,A) : c_interpbig(xi,G,A)
interp{T<:GridType,BT<:BasisFunction}(xi::Array{Float64},G::NGrid{T,BT},A::Array{Float64,2}) = length(G)<1500 ? c_interp(xi,G,A) : c_interpbig(xi,G,A)
