...
function epi_trend(Data, t_exp, naughty_exp, num_part)
...
reg=zeros(num_part^w, (t_exp+1)*(naughty_exp)^w)
...
for k=0:num_part^w-1
        ...
        reg[k+1, :]=genreg(Data[FS[k+1], 1:w+1], Data[FS[k+1], w+2],t_exp,naughty_exp)
