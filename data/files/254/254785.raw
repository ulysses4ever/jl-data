...
gridspace = 1   # don't get complacent wrt integers here
gridsize = (10, 10)
...
function noise(x::Float64, y::Float64)
    # divrem does the right thing for finding fractional part
    xgrid, xfrac = divrem(x, gridspace)  # lower grid coord, and fraction across the square
    ygrid, yfrac = divrem(y, gridspace)
    xgrid = r(xgrid)
    ygrid = r(ygrid)
