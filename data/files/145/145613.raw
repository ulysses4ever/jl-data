...
smc_sampler(n) = reshape(smcsampler(p, N=n, p = d, σ = 25.0)[d, :], n);
# get mcmc samples
tic()
...
plt.xlabel("Iterations", family = "serif");
...
plt.title(L"Histogram of iterations to within $2\%$ of true value of $E[x]$", family = "serif");
...
plt.title(L"Histogram of iterations to within $2\%$ of true value of $E[x^2]$", family = "serif");
plt.ylabel("Frequency", family = "serif");
plt.xlabel("Iterations", family = "serif");
plt.legend(["SMC Sampler", "MCMC"],frameon = false, prop={"size"=>12, "family"=>"serif"})
plt.ylim(0,35)
