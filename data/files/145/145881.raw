# a bunch of functions usefull for working with Microchip's RTDM (Real Time Data Monitor) interface

module MicrochipRTDM

export microchip_parsemap
#export rtdm_createreadcommand, rtdm_parsereadreply, 
#       rtdm_createwritecommand, rtdm_parsewritereply,
#       rtdm_sanitycheckcommand, rtdm_parsesanitycheckreply
...
### BEGIN functions to read .map file
...
### END functions to read .map file
