# reload("EMLTranslator/test/translateall.jl");  translateall();
using EMLTranslator
emlPath = Pkg.dir() * "/eml"
jEmlPath = Pkg.dir() * "/EMSOModelLibrary.jl/JuliaEMSOModels"
requirePath = "EMSOModelLibrary.jl/JuliaEMSOModels" 
