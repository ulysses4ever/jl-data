function SPExp(sp::SurplusProcess)
       ...
       s= 1 - (1 - loss_ratio / expense_ratio) * leng / duration 
       * exp(-(1/ aver- leng / duration / ( leng / duration * aver * 
       expense_ratio / loss_ratio) * initial_capital ) / 
       (1 / aver * leng / duration * aver * expense_ratio / loss_ratio - leng / duration);
end
#-------------------------------------------------------------------------------
