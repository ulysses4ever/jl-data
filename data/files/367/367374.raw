...
using CPLEX, MathProgBase, Gurobi, PyCall
using GeneralTools, ColorsTools
@pyimport scipy.spatial as pyspatial
...
#----------------------------------------------------------
function delaunay(p::Array{Float64,2})
  pytri = pyspatial.Delaunay(p)
  Tri = convert(Array{Int64,2},pytri["simplices"]) + 1
  return Tri
end
end # module
