...
function TestIntegralTransformation()
    ...
    if true
        ...
        plotComparison(num_basis_fns[1:nmols],full_fact_space+full_trans_space,"Full factorization plus transformation",struct_fact_space+struct_trans_space,"Structured factorization plus transformation","Number of basis functions","Space in Float64s)","Space to factorize and transform")
    end
