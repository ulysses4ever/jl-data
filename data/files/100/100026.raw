...
# facts("Disk tests without explicit label \"lastcollision\" ") do
#   D = Disk([1.0, 4.0], [2., 1.5],1.0, 1.0)
#     @fact D.r => [1.0,4.0]
#     @fact D.v => [2.0,1.5]
#     @fact D.radius => 1.0
#     @fact D.mass => 1.0
...
# facts("Disk tests without explicit label \"lastcollision\" and without mass ") do
#   D = Disk([1.0, 4.0], [2., 1.5],1.0)
#     @fact D.r => [1.0,4.0]
#     @fact D.v => [2.0,1.5]
#     @fact D.radius => 1.0
#     @fact D.mass => 1.0
