...
for nref=1:5
    ...
    modeldata= dmake(fens= fens,
                     region=[dmake(conductivity=kappa,
                                   fes=fes,integration_rule=GaussRule(dim=2,order=2))],
...
@test (norm(resultsTempA-[19.194292841311768,18.13007157921601,18.200556209588296,18.23969864743125,18.250188418309943])
     )<1.0e-6
