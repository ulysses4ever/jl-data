...
function surfacenormalspringstiffness{S<:FESet,T<:Number}(self::FEMMDeformationLinear{S}, 
...
function  surfacenormalspringstiffness{S<:FESet,
    A<:SysmatAssemblerBase,T<:Number}(self::FEMMDeformationLinear{S},assembler::A, 
              geom::NodalField{JFFlt}, u::NodalField{T},springconstant::JFFlt)
