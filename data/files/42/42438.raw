function updatevaluepaydrmDEBUG!( newvaluepaydrm::AbstractArray{Float64,3}, newbondprice::AbstractArray{Float64,2}, 
...
"""	This function returns updated array of value (current debt,reserves and m), policies: next debt, 
	...
	ires=1
		...
		idebt=2
			...
			print(thresholds[1:thresnum])
			println(threspolicy[1:thresnum,:])
			...
			(thresnum, debt1)=defaultthresholds!(thresholds, threspolicy, thresnum, thresdefault, # Outputs
								...
								debt1, res1)
			print(thresholds[1:thresnum])
			print(threspolicy[1:thresnum,:])
			println(thresdefault[1:thresnum])
