...
#=
bitstype 32 MYSQL_FIELD_OFFSET   <: Unsigned
bitstype  8 MYSQL_FIELD_TYPE     <: Unsigned
bitstype  8 MYSQL_TIMESTAMP_TYPE <: Signed
bitstype 16 MYSQL_OPTION         <: Unsigned
bitstype  8 MYSQL_PROTOCOL_TYPE  <: Unsigned
bitstype  8 MYSQL_STATUS         <: Unsigned
bitstype  8 MYSQL_SET_OPTION     <: Unsigned
bitstype  8 MYSQL_SHUTDOWN_LEVEL <: Unsigned
=#
typealias MYSQL_FIELD_OFFSET    UInt32
typealias MYSQL_OPTION          UInt16
typealias MYSQL_TIMESTAMP_TYPE  Int8
typealias MYSQL_FIELD_TYPE      UInt8
typealias MYSQL_PROTOCOL_TYPE	UInt8
typealias MYSQL_STATUS		UInt8
typealias MYSQL_SET_OPTION	UInt8
typealias MYSQL_SHUTDOWN_LEVEL  UInt8
