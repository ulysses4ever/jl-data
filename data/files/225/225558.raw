...
const PTHREAD_MUTEX_ADAPTIVE_NP = (UInt32)(3)
const PTHREAD_MUTEX_NORMAL = (UInt32)(0)
const PTHREAD_MUTEX_RECURSIVE = (UInt32)(1)
const PTHREAD_MUTEX_ERRORCHECK = (UInt32)(2)
const PTHREAD_MUTEX_DEFAULT = (UInt32)(0)
...
const PTHREAD_MUTEX_ROBUST_NP = (UInt32)(1)
...
const PTHREAD_RWLOCK_DEFAULT_NP = (UInt32)(0)
...
immutable _pthread_cleanup_buffer
    __routine::Ptr{Void}
    __arg::Ptr{Void}
    __canceltype::Cint
...
immutable xcb_connection_t
    data::Ptr{Void}
end

immutable xcb_generic_iterator_t
    data::Ptr{Void}
    rem::Cint
    index::Cint
end
...
immutable xcb_point_t
    x::Int16
    y::Int16
end

immutable xcb_point_iterator_t
...
immutable xcb_timecoord_iterator_t
...
immutable xcb_segment_iterator_t
