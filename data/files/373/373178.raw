...
channel(g::LJHGroup) = int(uniquefieldvalue(g, :channum))
record_nsamples(g::LJHGroup) = int(uniquefieldvalue(g, :nsamp))
pretrig_nsamples(g::LJHGroup) = int(uniquefieldvalue(g, :npre))
frametime(g::LJHGroup) = float(uniquefieldvalue(g, :dt))
